                    ...
                    <center>
                        <form class="block-vweighted block-weighted mt-2 mx-1" action="includes/violation.inc.php" method="post">
                                <div class="weight-50 mob-mb-1" id="order-1">
                                    <input type="submit" class="button-dark button-dark-main button-radius-violation con"
                                        name="Unaddressed"  value="Unaddressed" data-name="v" placeholder="" id="Unaddressed"/>
                                </div>
                                <div class="weight-50" id="order-3">
                                    <input type="submit" class="button-dark button-dark-main button-radius-violation con"
                                        name="Reviewed"  value="Reviewed" data-name="Reviewed" placeholder="" id="Reviewed"/>
                                </div>

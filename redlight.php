...
$query = "INSERT INTO video (violation, url, date_time, status) VALUES ('beating the red light','$file_path', '$date_time', 'Pending')";
// Execute the query
...
<head>
    <meta charset="utf-8" />
    <title>Violation Detector - Beating the Red Light</title>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetchData(data) {
                $.ajax({
                    url: "includes/red.data.inc.php",  // URL of the PHP script that retrieves data from database
...
<body class="bg-whitee">
    ...
    <div class="wrapper">
        ...
        <center>
            <h1 class="h2 my-2">Beating the Red Light</h1>
        </center>
            ...
            <center class="mb-1">
                ...
                <div class="content-hcenter h-min-200 mb-2 ">
                    <div class="video h-min-200">
                        ...
                        <div class=" mob-w-100">
                            <form class="px-2" action="includes/red.status.inc.php" method="post">

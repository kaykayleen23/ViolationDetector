					...
					<form action="includes/admin.regrem.inc.php" method="post">
                        <div class="block-weighted mb-1 block-vweighted mob-mb-1">
                            ...
                            <div class="weight-50" id="order-2">
                                ...
                                <div class=" mx-3">
                                    <input type="text" class="" maxlength="256" name="admin-id" data-name="Admind Id" placeholder="" id="input" />
                                </div>
                            </div>
                        </div>
                        <div class="block-weighted">
                            ...
                            <div class="weight-50">
                                <input type="submit" class="btn btn-danger"
                                    name="Remove"  value="Remove" data-name="Remove" placeholder="" id="Remove" />
                            </div>
                        </div>
					</form>
				</div> 
